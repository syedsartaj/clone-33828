...
import Herosectionthree from './components/Herosectionthree'; // Make sure path is correct
...
const Home = () => {
  ...
  const theme = {
    primaryColor: sheet2Data?.primaryColor || '#2563eb',
    secondaryColor: sheet2Data?.secondaryColor || '#e5e7eb',
  ...
  const renderCarouselLayout = () => {
                ...
                {categories.map((cat, idx) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ backgroundColor: theme.secondaryColor, fontFamily: theme.fontFamily }}
                    >
                      <h2 className="text-2xl font-semibold mb-4" style={{ color: theme.primaryColor }}>
                        {cat}
                      </h2>
                      <Carousel title={cat} posts={postsForCategory} />
                    </div>
          ...
          return (
            <section className="py-12" style={{ backgroundColor: theme.secondaryColor, fontFamily: theme.fontFamily }}>
              <div className="container mx-auto px-4">
                ...
                {activeCategory && (
                  <div>
                    <h2 className="text-3xl font-bold mb-6 text-center" style={{ color: theme.primaryColor }}>
                      {activeCategory}
                    </h2>
                    <Carousel
          ...
          return categories.map((cat, idx) => {
            ...
            return (
              <section
                ...
                className="py-12"
                style={{
                  backgroundColor: idx % 2 === 0 ? theme.secondaryColor : theme.primaryColor + '20',
                  fontFamily: theme.fontFamily,
                }}
              >
                <div className="container mx-auto px-4">
    ...
    return <div ref={carouselRef}>{renderByType()}</div>;
  };
  ...
  return (
    <div className="bg-gray-100 text-gray-900 min-h-screen" style={{ fontFamily: theme.fontFamily }}>
      <Navbar />
      <Herosectionthree
        heading="Smaksly — Build & Deploy"
        subheading="Effortlessly launch your next project"
        buttonText="Explore Blogs"
        onButtonClick={handleScrollToCarousel}
      />
      {loading ? (
